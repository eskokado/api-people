...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.esk.desafio.dio.EskPeopleApi.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "API Desafio Dio People com Spring Boot e MongoDb",
                "Esta API é utilizada no desafio DIO com Spring Boot e MongoDb",
                "Versão 1.0",
                "",
